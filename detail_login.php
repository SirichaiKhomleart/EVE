    		...
    		<form action="confirm.php">
    			<div class="detail">
    				<div class="box1">
						...
						<br><br>
						<div class="col-md-4">
							<h2 class="topic">Regular</h2><br>
						</div>
						
							<div class="col-md-8">
								<p class="quotef">฿ 3,500 x</p><input class="inputbox" id="number1" type="number" name="number1" min="0" max="100" step="1" value="0"/>
								<input class="nino-btnb" type="submit" name="buy" value="Buy Ticket"></input>
								<div style="clear:both;"></div>
					...
					<div class="box1">
						...
						<div class="col-md-8">
							...
							<input class="nino-btnb" type="submit" name="buy2" value="Buy Ticket"></input>
							<div style="clear:both;"></div>
						</div>
						<div style="clear:both;"></div>
					</div>
