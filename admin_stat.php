    	...
    	<div class="verticalCenter fw" >
    		<div class="container">
    			<div class="detail">
    				...
    				<div class="box"> 
    					<br>
						<h4 class="nino-sectionHeading">Event Ticket Status</h4>						
					</div>
					...
					<div class="box4">
						...
						<div class="row">
							...
							<div class="col-md-8">
								<p class="quotet1">Chang Music Connection Presents Waterzonic 2017</p>
								<p class="date1">Type : Premium<br>Organize : Change<br>Number of tickets : 2,000<br>Remain : 0/2,000<br>Type : Platinum<br>Organize : Change<br>Number of tickets : 2,000<br>Remain : 0/2,000</p><br>
					...
					<div class="box4">
						...
						<div class="row">
							...
							<div class="col-md-8">
								<p class="quotet1">Chang Music Connection Presents Waterzonic 2017</p>
								<p class="date1">Type : Normal<br>Organize : Change<br>Number of tickets : 2,000<br>Remain : 1,087/2,000<br></p><br>
					...
					<div class="box4">
						...
						<div class="row">
							...
							<div class="col-md-8">
								<p class="quotet1">Chang Music Connection Presents Waterzonic 2017</p>
								<p class="date1"><br>From : 31/10/2017 18:00 PM<br>Organize : Change</p><br>
								<br>
								<a href="detail.html" class="nino-btnb">See More</a>
							</div>
							<div style="clear:both;"></div>
