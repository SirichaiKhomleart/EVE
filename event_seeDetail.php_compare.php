...
$q = "SELECT * FROM event, organizer, eventType, eventEditLog
      ...
      AND eventEditLog.event_ID=event.event_ID
      AND eventEditLog.edit_approveStatus IS NULL
      ORDER BY eventEditLog.edit_timeStamp DESC";
...
//    exit;
//} else {
$event_name = $row['edit_name'];
$organizer_name = $row['organizer_name'];
$organizer_address = $row['organizer_address'];
$organizer_phone = $row['organizer_phone'];
$organizer_email = $row['organizer_email'];
//$event_type = $row['eventType_name'];
$event_location = $row['edit_location'];
$event_dateStart = $row['edit_dateStart'];
$event_dateEnd = $row['edit_dateEnd'];
$event_timeStart = $row['edit_timeStart'];
$event_timeEnd = $row['edit_timeEnd'];
$event_iconPicture = $row['edit_iconPicture'];
$event_posterPicture = $row['edit_posterPicture'];
$event_detail = $row['edit_detail'];
$event_create = $row['event_createTimeStamp'];
$event_edit =  $row['edit_timeStamp'];
            ...
            if ($compareMode == "on") {
                ...
                <div class="row">
                    <div class="col-md-4 col-md-offset-4">
                        ...
                        <div class="col-md-6">
                            <a href="event_seeDetail.php?eventID=<?php echo $eventID?>&&compareMode=on" class="nino-btninbox1">Old</a>
                        </div>
                        <div class="col-md-6">
                            <a href="event_seeDetail.php_compare.php?eventID=<?php echo $eventID?>" class="nino-btninbox2select">New</a>
                        </div>
                    </div>
                </div>
                <?php
            ...
            <div class="detail">
                ...
                while ($row = $result->fetch_array()) {
                    ...
                    <div class="box1">
                        ...
                        <div class="col-md-8">
                            <p class="quotef">
                                ฿ <?php echo $row['ticketType_price']; ?> <?php if ($_SESSION['current_type'] == "Customer") {
                                    echo "x";
                                } ?> </p>
                            <?php
                            ;
                ...
                $q = "SELECT * FROM event, ticketType
                    ...
                    AND event.event_dateEND >= CURRENT_DATE
                    AND event.event_ID=ticketType.event_ID
                    AND ticketType.ticketType_approveStatus IS NULL";
