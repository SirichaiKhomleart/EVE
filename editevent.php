    	...
    	<div class="verticalCenter fw" >
    		<div class="container">
    			<div class="detail">
    				<div class="box1"> 
    					<br>
						<h4 class="nino-sectionHeading">Edit Event</h4>
						<div class="box4">
							<div class="input">
								...
								<div class="col-md-9 pull-left">
									<input class="input" type="text" name="name" value="CHANG MUSIC CONNECTION PRESENTS WATERZONIC 2017">
								</div>	
							...
							<div class="input">
								...
								<div class="col-md-9 pull-left">
									<input class="input" type="text" name="organizer" value="CHANG">
								</div>	
								<div style="clear:both;"></div>
							</div>
							<div class="input">
								...
								<div class="col-md-9 pull-left">
									<input class="input" type="text" name="eventdate" value="29-30 September 2017">
								</div>	
								<div style="clear:both;"></div>
							</div>
							<div class="input">
								...
								<div class="col-md-3 pull-left">
									<input class="input1" type="text" name="eventtime" value="17:00 PM">
								</div>
							...
							<div class="input">
								...
								<div class="col-md-3 pull-left">
									...
									<input class="input1 " type="text" name="eventtime" value="Normal">
								</div>
								<div class="col-md-3 ">
									<span class="quotet">Price : </span>
									<input class="input1" type="text" name="eventtime" value="3,500">
								</div>
								<div class="col-md-3 ">
									<span class="quotet">Total Tickets : </span>
									<input class="input1" type="text" name="eventtime" value="2,000">
									<br>
									<br>
							...
							<div class="input">
								...
								<div class="col-md-9 pull-left">
									<input class="input2" type="text" name="eventtime" value="images/poster/event2.jpg">
									<a href=".nino-testimonial" class="nino-btnc pull-right">Browse</a>
								</div>
								<div style="clear:both;"></div>
							</div>
							<div class="input">
						...
						<div class="box1">					
							...
							<textarea name="eventdetail" cols="90"	rows="10" > เริ่มจัดส่งบัตร 1 สิงหาคม เป็นต้นไป / Delivery due in August 
 สถานที่จัดงาน 
 เงื่อนไขการเข้าร่วมงาน 
 -การเข้างานอายุ 18 ปีบริบูรณ์เท่านั้น / Only 18+ can entry the event
 -ทางทีมงานไม่รับผิดชอบกรณีบัตรสูญหาย หรือชำรุด หรือถูกทำลาย / Ticket cannot be replaced if lost, stolen or destroyed.
 -บัตรซื้อแล้วไม่รับคืนเงินทุกกรณี / Non-refundable / Non- returnable
							</textarea>
							<br>
							<br>							
