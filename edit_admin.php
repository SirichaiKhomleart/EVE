    			...
    			<div class="detail">
    				<div class="box1"> 
						...
						<div class="box4">
							...
							<div class="input">
								<div class="col-md-4 pull-left">
									<span class="quotet">Date (previous): </span>
								</div>
								<div class="col-md-8 pull-left">
							...
							<div class="input">
								<div class="col-md-4 pull-left">
									<span class="quotet">Date (new !): </span>
								</div>
								<div class="col-md-8 pull-left">
									<span class="quotet">27-28 September 2017</span>
								</div>	
								<div style="clear:both;"></div>
							</div>
							<div class="input">
						...
						<p class="quotet">-การเข้างานอายุ 18 ปีบริบูรณ์เท่านั้น / Only 18+ can entry the event
							...
							<br>
							<br>							
							<a href=".nino-testimonial" class="nino-btnb pull-right">Edit</a>
							<div style="clear:both;"></div>
						</div>
						<br>
					</div>
